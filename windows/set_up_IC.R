...
project_folder <- "C:\\Users\\user\\ownCloud\\Documents\\IntelliCage_data" # put your path here
results_folder <- "C:\\Users\\user\\ownCloud\\Documents\\IntelliCage_data\\results" # put your path here