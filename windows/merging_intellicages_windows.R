...
C2_visits2[which(C2_visits2$StartDate == unique(C2_visits2$StartDate)[1]),"StartDate"] <- unique(C2_visits$StartDate)[1]
C2_visits2[which(C2_visits2$StartDate == unique(C2_visits2$StartDate)[2]),"StartDate"] <- unique(C2_visits$StartDate)[2]
C2_visits2[which(C2_visits2$StartDate == unique(C2_visits2$StartDate)[3]),"StartDate"] <- unique(C2_visits$StartDate)[3]
C2_visits2[which(C2_visits2$StartDate == unique(C2_visits2$StartDate)[4]),"StartDate"] <- unique(C2_visits$StartDate)[4]
C2_visits2[which(C2_visits2$StartDate == unique(C2_visits2$StartDate)[5]),"StartDate"] <- unique(C2_visits$StartDate)[5]
C2_visits2[which(C2_visits2$StartDate == unique(C2_visits2$StartDate)[6]),"StartDate"] <- unique(C2_visits$StartDate)[6]

C3_visits2[which(C3_visits2$StartDate == unique(C3_visits2$StartDate)[1]),"StartDate"] <- unique(C3_visits$StartDate)[1]
C3_visits2[which(C3_visits2$StartDate == unique(C3_visits2$StartDate)[2]),"StartDate"] <- unique(C3_visits$StartDate)[2]
C3_visits2[which(C3_visits2$StartDate == unique(C3_visits2$StartDate)[3]),"StartDate"] <- unique(C3_visits$StartDate)[3]
C3_visits2[which(C3_visits2$StartDate == unique(C3_visits2$StartDate)[4]),"StartDate"] <- unique(C3_visits$StartDate)[4]
C3_visits2[which(C3_visits2$StartDate == unique(C3_visits2$StartDate)[5]),"StartDate"] <- unique(C3_visits$StartDate)[5]
C3_visits2[which(C3_visits2$StartDate == unique(C3_visits2$StartDate)[6]),"StartDate"] <- unique(C3_visits$StartDate)[6]
...
C2_nosepokes2[which(C2_nosepokes2$StartDate == unique(C2_nosepokes2$StartDate)[1]),"StartDate"] <- unique(C2_nosepokes$StartDate)[1]
C2_nosepokes2[which(C2_nosepokes2$StartDate == unique(C2_nosepokes2$StartDate)[2]),"StartDate"] <- unique(C2_nosepokes$StartDate)[2]
C2_nosepokes2[which(C2_nosepokes2$StartDate == unique(C2_nosepokes2$StartDate)[3]),"StartDate"] <- unique(C2_nosepokes$StartDate)[3]
C2_nosepokes2[which(C2_nosepokes2$StartDate == unique(C2_nosepokes2$StartDate)[4]),"StartDate"] <- unique(C2_nosepokes$StartDate)[4]
C2_nosepokes2[which(C2_nosepokes2$StartDate == unique(C2_nosepokes2$StartDate)[5]),"StartDate"] <- unique(C2_nosepokes$StartDate)[5]
C2_nosepokes2[which(C2_nosepokes2$StartDate == unique(C2_nosepokes2$StartDate)[6]),"StartDate"] <- unique(C2_nosepokes$StartDate)[6]

C3_nosepokes2[which(C3_nosepokes2$StartDate == unique(C3_nosepokes2$StartDate)[1]),"StartDate"] <- unique(C3_nosepokes$StartDate)[1]
C3_nosepokes2[which(C3_nosepokes2$StartDate == unique(C3_nosepokes2$StartDate)[2]),"StartDate"] <- unique(C3_nosepokes$StartDate)[2]
C3_nosepokes2[which(C3_nosepokes2$StartDate == unique(C3_nosepokes2$StartDate)[3]),"StartDate"] <- unique(C3_nosepokes$StartDate)[3]
C3_nosepokes2[which(C3_nosepokes2$StartDate == unique(C3_nosepokes2$StartDate)[4]),"StartDate"] <- unique(C3_nosepokes$StartDate)[4]
C3_nosepokes2[which(C3_nosepokes2$StartDate == unique(C3_nosepokes2$StartDate)[5]),"StartDate"] <- unique(C3_nosepokes$StartDate)[5]
C3_nosepokes2[which(C3_nosepokes2$StartDate == unique(C3_nosepokes2$StartDate)[6]),"StartDate"] <- unique(C3_nosepokes$StartDate)[6]
